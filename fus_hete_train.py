...
train_features_dir = './Feature/FUS in FUS-LAF/feature_train'
train_edges_dir = './Contactmap/FUS in FUS-LAF/distance_train'
test_features_dir = './Feature/FUS in FUS-LAF/feature_test'
test_edges_dir = './Contactmap/FUS in FUS-LAF/distance_test'
label_file = './Dataset/FUS in FUS-LAF/test_fus_hete.txt'

model_path = './Model/FUS in FUS-LAF/Pretrain_fus_c.pth'
